...
export class WorkerService {
    ...
    constructor(private readonly ftpService: FtpService, private readonly utilsService: UtilsService) {}
    ...
    async processWarnings() {
        ...
        for (const warningKey of warnings) {
            try {
                ...
                const warningText = await this.ftpService.downloadWarningText(cleanWarningKey);
